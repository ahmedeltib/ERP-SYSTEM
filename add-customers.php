...
if($_SERVER['REQUEST_METHOD']=="POST"){
  ...
  $queryINSERTcustomers = "INSERT INTO `customers`(`name`, `phone`, `addres`) VALUES
  ('{$name}','{$phone}','{$addres}')";


$resultINSERTcustomers =  mysqli_query($connection, $queryINSERTcustomers);
 
  $result=" تم الاضافة بنجاح";
  if(!$resultINSERTcustomers){
